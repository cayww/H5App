  ...
  return (
    <div className="agreement-page">
      ...
      <div className="agreement-content">
        <h1>Comhe Privacy Policy</h1>
        <p className="update-time">Last updated: 2026</p>

        <p>
          Welcome to <strong>Comhe</strong>. Your privacy is very important to us. This Privacy
          Policy explains how Comhe collects, uses, and protects your information when you use our
        ...
        <ul>
          <li>Provide and improve Comhe services</li>
        ...
        <p>
          Comhe does not sell or rent your personal information. We may share information only in
        ...
        <p>
          Comhe is not intended for individuals under the age required by applicable law. We do not
        ...
        <p>
          Comhe may update this Privacy Policy from time to time. Continued use of the service after
        ...
        <p>
          ...
          channel provided within the Comhe application.
        </p>
      </div>
    </div>
  )
