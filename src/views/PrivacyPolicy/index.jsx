  ...
  return (
    <div className="agreement-page">
      ...
      <div className="agreement-content">
        <h1>Saze Privacy Policy</h1>
        <p className="update-time">Last updated: 2026</p>

        <p>
          Welcome to <strong>Saze</strong>. Your privacy is very important to us. This Privacy
          Policy explains how Saze collects, uses, and protects your information when you use our
        ...
        <ul>
          <li>Provide and improve Saze services</li>
        ...
        <p>
          Saze does not sell or rent your personal information. We may share information only in the
        ...
        <p>
          Saze is not intended for individuals under the age required by applicable law. We do not
        ...
        <p>
          Saze may update this Privacy Policy from time to time. Continued use of the service after
        ...
        <p>
          ...
          channel provided within the Saze application.
        </p>
      </div>
    </div>
  )
